// Giffy Key = NWabowdySQgQGaZD5HDd9cEZsAbNCkhh
//
...
// GIFTASTIC! 
var topics = ["Sudan", "Yemen", "Rohingya", "Mapuche", "Flint", "western sahara", "Syria", "Quechua", "Palestine"];
...
// The user clicks on a generated teal button, which generates 10 static, non-animated gif images from the GIPHY API and places them on the page. 
  		...
  		$.ajax({
          	...
          	for (var i = 0; i < results.length; i++) {
                ...
                // a div is created to hold a gif of any topic
	 			...
	 			var topicImage = $("<img>").addClass("tealBorder");
